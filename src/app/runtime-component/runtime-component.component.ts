...
@Component({
  ...
  template: `
    <div style="text-align:center ; font-family:sans-serif;"> <h1>Rich Text Editor</h1></div>
    <div #container></div>
  `,
...
export class RuntimeComponentComponent implements OnInit {
  ...
  temp: string =
    '<div class="container">' +
    '<div class="row">' +
    '   <div class="col-4" style="background-color: rgb(69, 139, 19); border:solid 2px black ; border-radius:8px ; height:600px ; margin-right:20px ; margin-top : 20px">' +
    ...
    " " +
    " " +
    '   <div class="col-7" id="doithere" style="background-color:white ; border-radius : 7px ; height : 820px ; margin-top:20px;overflow-y: auto;">' +
    '   <div class="row">' +
    '      <div class="col">' +
    '         <div id="whatif0">' +
    "            <h4> Section 1 </h4>" +
